...
# ========================================================================================= #
# File: GearboxFramework_structs.h
#############################################################################################
*/
...
struct FHttpParameters
{
	...
	unsigned long                                      NoRetry : 1;                                      		// 0x0034 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FArchwayResult
{
	...
	struct FString                                     NeedsSignAgreements;                              		// 0x0064 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	class UJsonObject*                                 EulaArray;                                        		// 0x0070 (0x0004) [0x0000000000100000]              
	struct FString                                     SupportId;                                        		// 0x0074 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FEULAData
{
	...
	struct FString                                     Version;                                          		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Type;                                             		// 0x0010 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Title;                                            		// 0x001C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Text;                                             		// 0x0028 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bLocalSigned : 1;                                 		// 0x0034 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bSeen : 1;                                        		// 0x0034 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	struct FString                                     ObjectPath;                                       		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
