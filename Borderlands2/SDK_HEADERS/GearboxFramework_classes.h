...
public:
	...
	class UGFxMovieDefinition*                         EulaMovieDefinition;                              		// 0x0044 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
...
// 0x006C (0x0700 - 0x0694)
class AGearboxPawn : public AGamePawn
{
public:
	struct FPointer                                    VfTable_ISpecialMoveInterface;                    		// 0x0694 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	struct FPointer                                    VfTable_IGearboxDialogInterface;                  		// 0x0698 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	struct FName                                       NPCSightBone;                                     		// 0x069C (0x0008) [0x0000000000000000]              
	unsigned long                                      bWantsToMove : 1;                                 		// 0x06A4 (0x0004) [0x0000000000000000] [0x00000001] 
	class USpecialMoveComponent*                       SMComponent;                                      		// 0x06A8 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FReplicatedSpecialMoveData                  ReplicatedSMData;                                 		// 0x06AC (0x0014) [0x0000000000000020]              ( CPF_Net )
	struct FFlag                                       HasBeenShotAtRecently;                            		// 0x06C0 (0x0010) [0x0000000000002000]              ( CPF_Transient )
	struct FGearboxCoverState                          CoverState;                                       		// 0x06D0 (0x000C) [0x0000000000002020]              ( CPF_Net | CPF_Transient )
	class UGearboxCoverStateManager*                   CoverManager;                                     		// 0x06DC (0x0004) [0x0000000004402008]              ( CPF_ExportObject | CPF_Transient | CPF_NeedCtorLink | CPF_EditInline )
	class UGearboxDialogComponent*                     DialogComponent;                                  		// 0x06E0 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FGearboxDialogReplicatedData                DialogReplicatedData;                             		// 0x06E4 (0x0014) [0x0000000000000020]              ( CPF_Net )
	struct FAkPlayingInfo                              DyingScream;                                      		// 0x06F8 (0x0008) [0x0000000000082000]              ( CPF_Transient | CPF_Component )
...
UClass* UGearboxEULAGFxMovieDefinition::pClassPointer = NULL;
...
public:
	...
	TArray< class UPopulationAspect* >                 Aspects;                                          		// 0x01C4 (0x000C) [0x000000000440000B]              ( CPF_Edit | CPF_Const | CPF_ExportObject | CPF_NeedCtorLink | CPF_EditInline )
	int                                                SpawnIndex;                                       		// 0x01D0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< int >                                      SpawnList;                                        		// 0x01D4 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	int                                                InclusiveSpawnIndex;                              		// 0x01E0 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< int >                                      InclusiveSpawnList;                               		// 0x01E4 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
...
{
public:
	TArray< struct FPopulationOptionAreaData >         SpawnOptions;                                     		// 0x01F0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      bContinueSpawningAfterPlayerDetected : 1;         		// 0x01FC (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bOpportunityVolume : 1;                           		// 0x01FC (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bOpportunityRadius : 1;                           		// 0x01FC (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bOpportunityLevel : 1;                            		// 0x01FC (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bPlayerHasBeenDetected : 1;                       		// 0x01FC (0x0004) [0x0000000000002000] [0x00000010] ( CPF_Transient )
	TArray< class AVolume* >                           DetectionVolumes;                                 		// 0x0200 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              DetectionRadius;                                  		// 0x020C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                SelectedSpawnIdx;                                 		// 0x0210 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< struct FPopulationAreaOptionSpawnData >    SpawnData;                                        		// 0x0214 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< class APlayerController* >                 PlayersDetected;                                  		// 0x0220 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	int                                                NumPlayersDetected;                               		// 0x022C (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
{
public:
	class UExpressionEvaluator*                        Conditions;                                       		// 0x01F0 (0x0004) [0x0000000004000001]              ( CPF_Edit | CPF_EditInline )
	class UPopulationFactory*                          SpawnFactory;                                     		// 0x01F4 (0x0004) [0x0000000004000001]              ( CPF_Edit | CPF_EditInline )
	int                                                MaxTotalActors;                                   		// 0x01F8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                MaxActiveActors;                                  		// 0x01FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      RespawnStyle;                                     		// 0x0200 (0x0001) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	unsigned long                                      bTotalResetOnLevelLoad : 1;                       		// 0x0204 (0x0004) [0x0000000000000003] [0x00000001] ( CPF_Edit | CPF_Const )
	unsigned long                                      bReadyToSpawn : 1;                                		// 0x0204 (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	float                                              RespawnDelay;                                     		// 0x0208 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              RespawnDelayAfterDeath;                           		// 0x020C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                NumTotalActors;                                   		// 0x0210 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	int                                                NumActiveActors;                                  		// 0x0214 (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
// 0x009C (0x028C - 0x01F0)
class APopulationOpportunityCombat : public APopulationOpportunity
{
public:
	struct FPointer                                    VfTable_IIGbxMessageListener;                     		// 0x01F0 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	class APopulationEncounter*                        ParentEncounter;                                  		// 0x01F4 (0x0004) [0x0000000000220001]              ( CPF_Edit | CPF_EditConst )
	int                                                ParentEncounterWave;                              		// 0x01F8 (0x0004) [0x0000000000220001]              ( CPF_Edit | CPF_EditConst )
	class UPopulationDefinition*                       PopulationDef;                                    		// 0x01FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FAttributeInitializationData                MaxTotalActorsFormula;                            		// 0x0200 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	int                                                MaxTotalActors;                                   		// 0x0210 (0x0004) [0x0000000000000000]              
	int                                                MaxActiveActorsIsNormal;                          		// 0x0214 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                MaxActiveActorsThreatened;                        		// 0x0218 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FAttributeInitializationData                RespawnDelayFormula;                              		// 0x021C (0x0010) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bAdjustForPlayerCount : 1;                        		// 0x022C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bOpportunityVolume : 1;                           		// 0x022C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bOpportunityRadius : 1;                           		// 0x022C (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bPlayerHasBeenDetected : 1;                       		// 0x022C (0x0004) [0x0000000000002000] [0x00000008] ( CPF_Transient )
	unsigned long                                      bShowDebugEnabled : 1;                            		// 0x022C (0x0004) [0x0000000000000000] [0x00000010] 
	TArray< class AVolume* >                           DetectionVolumes;                                 		// 0x0230 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              DetectionRadius;                                  		// 0x023C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              OpportunityHeight;                                		// 0x0240 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      RadiusDebugColor;                                 		// 0x0244 (0x0004) [0x0000000000000000]              
	float                                              RespawnDelay;                                     		// 0x0248 (0x0004) [0x0000000000000000]              
	class UDrawSphereComponent*                        DetectionDrawSphere;                              		// 0x024C (0x0004) [0x0000000004082008]              ( CPF_ExportObject | CPF_Transient | CPF_Component | CPF_EditInline )
	float                                              ActivePlayerScale;                                		// 0x0250 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< class AGearboxPawn* >                      SpawnedMembers;                                   		// 0x0254 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	struct FPopulationOptionSpawnData                  SpawnData;                                        		// 0x0260 (0x001C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< class APlayerController* >                 PlayersDetected;                                  		// 0x027C (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	int                                                NumPlayersDetected;                               		// 0x0288 (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
{
public:
	struct FPointer                                    VfTable_IIPopulationSpawnPoint;                   		// 0x01F0 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	class UPopulationDefinition*                       PopulationDef;                                    		// 0x01F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SpawnAndCullRadius;                               		// 0x01F8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UBehaviorBase* >                     SpawnCustomizations;                              		// 0x01FC (0x000C) [0x0000000004400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink | CPF_EditInline )
	unsigned long                                      SpawnedForMatinee : 1;                            		// 0x0208 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bHasSpawned : 1;                                  		// 0x0208 (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	unsigned long                                      bActiveSpawn : 1;                                 		// 0x0208 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	unsigned long                                      bDetectedPlayer : 1;                              		// 0x0208 (0x0004) [0x0000000000002000] [0x00000008] ( CPF_Transient )
	unsigned char                                      AISpawnStyle;                                     		// 0x020C (0x0001) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	unsigned char                                      InitialAction;                                    		// 0x020D (0x0001) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	TArray< class AActor* >                            InitialActionDestinations;                        		// 0x0210 (0x000C) [0x0000000000400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	int ReadEULAChain ( unsigned char ControllerId, unsigned long bAllowRetries, unsigned long bIsRequiredRequest );
...
public:
	...
	unsigned char                                      AgreementsSigning;                                		// 0x0090 (0x0001) [0x0000000000000000]              
	struct FString                                     SupportId;                                        		// 0x0094 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
public:
	...
	bool IsDisabled ( );
	bool IsInitializing ( );
	void UpdateAgreementsSigning ( class UGearboxAccountData* GbxAccountData, struct FString NeedsSignAgreements );
...
public:
	...
	bool GetBoolParameter ( struct FString KeyName, unsigned long Default );
...
{
public:
	class UGearboxEULAGFxObject*                       GearboxEULAObj;                                   		// 0x0254 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      CurrentControllerId;                              		// 0x0258 (0x0001) [0x0000000000000000]              
	TArray< struct FEULAData >                         EULAs;                                            		// 0x025C (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	int                                                EULAIndexToDisplay;                               		// 0x0268 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FScriptDelegate                             __OnEULAInteractionComplete__Delegate;            		// 0x026C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42417 ];
...
UClass* UGearboxEULAGFxMovie::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42425 ];
	...
	void NavigateDown ( );
	void NavigateUp ( );
	void SetTooltipText ( struct FString AcceptText, struct FString DeclineText );
	void SetEULAText ( struct FString Title, struct FString Text );
	void Init ( );
};

UClass* UGearboxEULAGFxObject::pClassPointer = NULL;
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 42742 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43258 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43571 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 43670 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44463 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44619 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44702 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44719 ];
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->Data[ 44733 ];
