...
{
	unsigned long                                      bShowing : 1;                                     		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
...
{
	unsigned char                                      MinEffectiveLevel;                                		// 0x0000 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	...
	float                                              PlayerVehicleWeaponDamageMultiplier;              		// 0x002C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FAttributeEffectData >              AttributeEffectsForSpawnedEnemies;                		// 0x0030 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FAttributeEffectData >              AttributeEffectsForPlayers;                       		// 0x003C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FAttributeInitializationData                AmmoDropsPerPlayerMultiplier;                     		// 0x0048 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FAttributeInitializationData                GearDrops_CommonWeightModifier_PT3_BaseValueOverride;		// 0x0058 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FAttributeInitializationData                ChestItemPool_Weight_2_Uncommon_PT3_Multiplier;   		// 0x0068 (0x0010) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	TArray< struct FLevelBasedStatusEffectChanceScale > StatusEffectChanceScales;                         		// 0x0078 (0x000C) [0x0000000000400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink )
	TArray< struct FLevelBasedDamageScale >            AIDamageScaleByLevelDifference;                   		// 0x0084 (0x000C) [0x0000000000400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink )
};
...
{
	int                                                EridiumCostForUpgrade;                            		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FMapSpecificBalanceModificationList
{
	...
	TArray< class UAIPawnBalanceModifierDefinition* >  AIPawnBalanceModifiers;                           		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	int                                                PlayThroughNumber;                                		// 0x0000 (0x0004) [0x0000000020000001]              ( CPF_Edit | CPF_Deprecated )
...
{
	unsigned long                                      bIsItemPool : 1;                                  		// 0x0000 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FName                                       ObjectName;                                       		// 0x0004 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     ObjectPath;                                       		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	struct FString                                     AIPawnBalanceDefinitionFullObjectName;            		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     DisplayName;                                      		// 0x000C (0x000C) [0x0000000000408003]              ( CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	TArray< struct FAITransformedName >                TransformedNames;                                 		// 0x0018 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FInputDeviceButtonData
{
	...
	class UInputActionDefinition*                      RemapToDefaultLayoutInputAction;                  		// 0x0040 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
};
...
struct FLoadCharacterData
{
	...
	class UDownloadableCharacterDefinition*            SaveDlcCharDef;                                   		// 0x0074 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< struct FName >                             Skills;                                           		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     NewPlayerInjuredString;                           		// 0x000C (0x000C) [0x0000000000408003]              ( CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     NewInjuredTooltipString1;                         		// 0x0018 (0x000C) [0x0000000000408003]              ( CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink )
	struct FString                                     NewInjuredTooltipString2;                         		// 0x0024 (0x000C) [0x0000000000408003]              ( CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink )
};
