...
struct FTOCInfo
{
	struct FString                                     TOC;                                              		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     RootPath;                                         		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     Path;                                             		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FOnlineContent
{
	...
	struct FTOCInfo                                    TOCInfo;                                          		// 0x0058 (0x0024) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
// 0x0021(0x009D - 0x007C)
struct FNamedOnlineContent : FOnlineContent
{
	struct FOnlineContentNameInfo                      NameInfo;                                         		// 0x007C (0x0020) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      NamedContentType;                                 		// 0x009C (0x0001) [0x0000000000000000]              
};
...
struct FCompatibilityOnlineContent
{
	...
	struct FNamedOnlineContent                         Container;                                        		// 0x0004 (0x00A0) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FNamedOnlineContent >               Content;                                          		// 0x00A4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	TArray< struct FName >                             PartMeshNames;                                    		// 0x0000 (0x000C) [0x0000000000420001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	class USkeletalMesh*                               SkeletalMesh;                                     		// 0x000C (0x0004) [0x0000000000020001]              ( CPF_Edit | CPF_EditConst )
	TArray< struct FGestaltLODModel >                  LODModelData;                                     		// 0x0010 (0x000C) [0x0000000000420001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	TArray< struct FSocketRemapEntry >                 SocketMappings;                                   		// 0x001C (0x000C) [0x0000000000420001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	TArray< struct FGestaltAccessoryEntry >            GestaltAccessoryList;                             		// 0x0028 (0x000C) [0x0000000000420001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	class UGestaltPartMatrices*                        GestaltPartMatricesContainer;                     		// 0x0034 (0x0004) [0x0000000000022001]              ( CPF_Edit | CPF_Transient | CPF_EditConst )
	struct FBoxSphereBounds                            ReferencePoseBounds;                              		// 0x0038 (0x001C) [0x0000000000022001]              ( CPF_Edit | CPF_Transient | CPF_EditConst )
};
